    ...
    public partial class Settings : Window
    {
         ...
         private void butBrowse_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
              ...
              //  MessageBox.Show(Path.GetDirectoryName(dlg.FileName) + @"\" + filename);
              //string filepath= Path.GetDirectoryName(dlg.FileName);
              //  System.IO.FileInfo file = new System.IO.FileInfo(Path.GetDirectoryName(dlg.FileName) + @"\" + filename);
               
                MessageBox.Show(GetFileSize(new System.IO.FileInfo(dlg.FileName)));
        ...
        private void butSend_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string filesize = GetFileSize(new System.IO.FileInfo(tbName.Text));
                ...
                canalHandler.SendFile(fileName, filesize);
               // canalHandler.SendFileSize(fileName, filesize);
       ...
       public void SavePrompt(string fileName, string size)
        {
            ...
            Dispatcher.BeginInvoke(new Action(() =>
            {
                ...
                MessageBoxResult result = MessageBox.Show("Имя файла: " + fileName +"\n"+ "Принять данный файл?", "Сообщение", MessageBoxButton.YesNo, MessageBoxImage.Question);
        ...
        private void SaveFile(string fileName)
        {
            ...
            string a1;
            int k;
            k = fileName.IndexOf('\n');//5 в данном случае нужный тебе символ
            dlg.FileName = fileName.Substring(0, k);
